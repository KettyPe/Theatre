(() => {
    ...
    function initSliders() {
        if (document.querySelector(".emblems__slider")) new core(".emblems__slider", {
            modules: [ Pagination ],
            observer: true,
            observeParents: true,
            slidesPerView: 5,
    ...
    function documentActions(e) {
        ...
        if (targetElement.classList.contains("fa-magnifying-glass")) document.querySelector(".search-form").classList.toggle("_active-form"); else if (!targetElement.closest(".search-form") && document.querySelector(".search-form._active-form")) document.querySelector(".search-form").classList.remove("_active-form");
    }
